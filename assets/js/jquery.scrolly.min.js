...
(function(e){
    function u(s,o){
        ...
        switch(o.anchor){
            case"middle":f=a-(e(window).height()-u.outerHeight())/2;
            break;
        ...
        e.fn.scrolly=function(i){
            ...
            a=jQuery.extend({anchor:r,easing:"swing",offset:0,parent:e("body,html"),pollOnce:!1,speed:1e3},i),a.pollOnce&&(l=u(f,a)),c.off(s).on(s,
